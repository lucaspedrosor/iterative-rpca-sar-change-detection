%% Iterative RPCA-Based SAR Change Detection Example
%
% This example demonstrates how to execute the iterative RPCA-based
...
%% Run the proposed iterative RPCA method

result = iterative_rpca_cd( ...
    surveillanceImage, ...
    referenceImage, ...
    parameters);
...
axis image off
title(sprintf( ...
    'Detection Map (\\lambda multiplier = %d)', ...
    result.lambdaMultiplier))

colormap(gray)

sgtitle('Iterative RPCA-Based SAR Change Detection')